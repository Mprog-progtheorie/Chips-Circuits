"""
linespacer_xdirection.py

Tom Kamstra, Izhar Hamer, Julia Linde

Finds the optimal paths between gates based on distance in x-direction.
...
with open('../output/output_linespacerxdirection.csv', mode= 'w') as outputfile:
